# -*- coding: utf-8 -*-
#
# ESGF PID Consumer Tests documentation build configuration file, created by
# sphinx-quickstart on Thu Nov 10 11:21:55 2016.
#
...
#
# html_title = u'ESGF PID Consumer Tests v0.1'
...
htmlhelp_basename = 'ESGFPIDConsumerTestsdoc'
...
# Check if the modules I'd like to autodocument
# can be imported:
#import messages
#print("TYPE: "+str(messages.Messages))
#print("FOO: "+str(messages.Messages.FOO))
#import miau
#print("MIAU.kaaa: "+str(miau.Miau.kaaa))