...
class NodeManager(object):
    ...
    def __complete_info_dict(self, node_info_dict, is_open):
        ...
        # Get some defaults:
        socket_timeout = esgfpid.defaults.RABBIT_SOCKET_TIMEOUT
        connection_attempts = esgfpid.defaults.RABBIT_CONNECTION_ATTEMPTS
        retry_delay = esgfpid.defaults.RABBIT_CONNECTION_RETRY_DELAY_SECONDS
